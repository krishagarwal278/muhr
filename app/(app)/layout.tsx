...
const navItems = [
  ...
  { label: "Settings", href: "/settings", icon: "settings", tour: "settings" as const },
];
...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-[#f5f5f7] text-neutral-950">
      {user ? <NavTourBootstrap userId={user.id} /> : null}

      {/* Mobile section strip (guided tour + quick nav) */}
      <nav
      ...
      {/* Main content — extra top padding on small screens for mobile nav strip */}
